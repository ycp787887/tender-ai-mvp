...
系统运行时的真实日志记录，展示 API 调用、缓存命中/未命中、资质缺失警告等：


![日志示例](docs/images/log-demo.png)

*日志展示：API调用、缓存命中、资质缺失警告*

### 数据库截图

历史记录表结构和存储内容，证明前后端分离与持久化能力：

![数据库表结构](docs/images/database-schema.png)

*数据库展示：时间戳、项目名称、公司名称、废标状态*
